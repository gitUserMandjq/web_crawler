...
public interface Expect extends Closeable {
     ...
     * @throws IOException if I/O error occurs
     * @see #send(String)
     * @see ExpectBuilder#withLineSeparator(String)
     */
     ...
     * timeout.
     * <p/>
     * The method throws an {@link AssertionError} if
     * {@link ExpectBuilder#errorOnTimeout} is set. Deprecated.
     * <p/>
     ...
     * @throws ExpectIOException if the matcher does not match and the
     * the {@link ExpectBuilder#withExceptionOnFailure()} flag was set
     ...
     * {@link #withTimeout(long, TimeUnit)} to change the timeout for the
     * expect operation.
     */
    @Deprecated
