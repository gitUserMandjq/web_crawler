...
public class ExpectBuilder {
     ...
     * @return this
     * @throws IllegalArgumentException if the timeout {@code <= 0}
     */
     ...
     * echoed to it.
     * <p/>
     * The build method throws an {@link IllegalArgumentException} if the number of the
     * {@code otherInputs}
     ...
     * builder's charset. See {@link ExpectBuilder#withCharset(Charset)} for
     * more information.
     *
    ...
    /**
     * Enables throwing an {@link AssertionError} if any expect operation times out.
     ...
     * @return this
     * @throws IllegalArgumentException if {@code bufferSize} is <= 0
     */
     ...
     *
     * @param autoFlushEcho the auto flushing flag.
     * @return this
     */
     ...
     * @throws IllegalStateException if the {@code inputs} are incorrect
     */
