...
public final class Matchers {
     ...
     * expression.
     * <p/>
     * This method simply compiles the given pattern to a {@link Pattern} and
     * passes it to the
     * {@link #matches(Pattern)} method.
     *
     ...
     * expression.
     * <p/>
     * This method simply compiles the given string to a {@link Pattern} and
     * passes it to the
     * {@link #regexp(Pattern)} method.
     *
     ...
     * <p/>
     * If succeeded, the {@link Result#getBefore()} will return the entire input
     * buffer, and
     * the {@link Result#group()} returns an empty string.
     *
     * @return the matcher
     */
     ...
     * <p/>
     * If the result is successful, the {@link Result#getBefore()} returns an
     * empty string, the
     * {@link Result#group()} returns the entire input buffer.
     *
     * @return the result
     */
     ...
     * <p/>
     * If the result is successful, the {@link Result#getBefore()} returns an
     * empty string, the {@link Result#group()} returns the entire input buffer.
     *
     ...
     * <p/>
     * If the result is successful, the {@link Result#getBefore()} returns an
     * empty string, the {@link Result#group()} returns the given string.
     *
